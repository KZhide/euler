...
/* package p041-0.1.0.0 */
#define VERSION_p041 "0.1.0.0"
#define MIN_VERSION_p041(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "p041-0.1.0.0-IJLXMQnhzPiIO01BL5iGZT"

#define CURRENT_PACKAGE_KEY "p041-0.1.0.0-IJLXMQnhzPiIO01BL5iGZT"
